...
class IyzicoResponseObjectGenerator
{
    ...
    public function generatePaymentDetailObject($conversationId, $paymentId)
    {
        $paymentDetail = new stdClass();

        $paymentDetail->locale = "tr";
        $paymentDetail->conversationId = (string) $conversationId ? (string) $conversationId : "123456789";
        $paymentDetail->paymentId = (string) $paymentId;
