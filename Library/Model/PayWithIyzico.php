...
use Iyzico\Iyzipay\Library\Request\RetrievePayWithIyzicoRequest;
...
class PayWithIyzico extends PaymentResource
{
    ...
    public static function retrieve(RetrievePayWithIyzicoRequest $request, Options $options)
    {
        ...
        $rawResult = parent::httpClient()->post($options->getBaseUrl().$uri,
            parent::getHttpHeadersV2($uri, $request, $options), $request->toJsonString());
