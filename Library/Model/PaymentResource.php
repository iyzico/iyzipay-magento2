...
class PaymentResource extends IyzipayResource
{
    ...
    public function getMaturityChargeAmount()
    {
        return $this->maturityChargeAmount;
    }

    public function setMaturityChargeAmount($maturityChargeAmount)
    {
        $this->maturityChargeAmount = $maturityChargeAmount;
    }
}
